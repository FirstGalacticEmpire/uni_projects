...
sources = np.array([10,10,10,10])
demands = np.array([10,10,10,10])
...
class Table:
    ...
    def change_base(self, cell_to_enter_base):
        ...
        for cell in chosen_cells:
            ...
            # if cell.is_a_bad_boy:
            #     print("Kurwa", cell)
            #     print()
        # chosen_cells[0].is_base = True
        # # todo to powinno być inaczej
        # chosen_cells[-1].is_base = False
            if cell.current_value == 0 and not cell.is_a_bad_boy:
                print("luasd", cell)
                # print()
                cell.is_base = False
